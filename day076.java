...
public class NewClass2 {
    public static void main(String[] args) {
        ...
        if(nama1.equals(nama2)){
            System.out.println("equals() = teks sama persis");
            
      }else{
            System.out.println("equalse() = teks tdk sama");
            
            //2.equalsIgnoreCase()
            System.out.println("2.equalsIgnoreCase()");
            if (nama1.equalsIgnoreCase(nama2)) {
                System.out.println("equalsIgnoreCase() = teks sama ");
            } else {
                System.out.println("equalsIgnoreCase() = teks tdk sama");
                 //3.contains()
